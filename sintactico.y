%tokens MAIN INIBLO ENDBLO INIVAR ENDVAR TYPEVAR SEMICOLON COMMA LIST VACIO ID INIPA ENDPA ASIGN SEMICOLON IF ELSE WHILE FOR ITEFOR CONST_INT DO READ PRINT RETURN LISTOP1 LISTOP2 WORD
%start S
